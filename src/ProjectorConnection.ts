...
const KeystoneVerticalDecrease: number[] = [0x06, 0x14, 0x00, 0x04, 0x00, 0x34, 0x12, 0x0A, 0x00, 0x68];
const KeystoneVerticalIncrease: number[] = [0x06, 0x14, 0x00, 0x04, 0x00, 0x34, 0x12, 0x0A, 0x01, 0x69];
const KeystoneVertical: number[] = [0x07, 0x14, 0x00, 0x05, 0x00, 0x34, 0x00, 0x00, 0x12, 0x0A, 0x69];
const KeystoneHorizontalDecrease: number[] = [0x06, 0x14, 0x00, 0x04, 0x00, 0x34, 0x11, 0x31, 0x00, 0x8E];
const KeystoneHorizontalIncrease: number[] = [0x06, 0x14, 0x00, 0x04, 0x00, 0x34, 0x11, 0x31, 0x01, 0x8F];
